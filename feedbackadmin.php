          ...
          <div class="menu">
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation"><a href="indexadmin.php" >Update / Delete Books</a></li>
                ...
                <li role="presentation"><a href="feedbackadmin.php" class="active">Feedback</a></li>
  ...
  <div class="gallery">
      ...
      <div class="container" style="border-radius: 15px;background-color:#e0e0e0;width:700px;">
          ...
          <?php
                 ...
                 $sql = "select * from orm_feedback  order by feedback_id desc";
		...
		<?php
          ...
          <div class="container" style="border: 1px solid black;width:600px;">
              <br/>
              <h4 ><b>User Name :</b></h4>
              <h4><?php echo $row['feedback_name']; ?></h4><br/>
              <h4 ><b>Email   :</b></h4>
              <h4><?php echo $row['feedback_email']; ?></h4><br/>
              <h4 ><b>Subject :</b></h4>
              <h4><?php echo $row['feedback_subject']; ?></h4><br/>
              <h4 ><b>Message :</b></h4>
              <h4> <?php echo $row['feedback_message']; ?></h4><br/>
          </div>
