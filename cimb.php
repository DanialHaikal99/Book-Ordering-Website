...
<div class="text-center">
    ...
    <h3>Instructions To Transfer To Our Cimb Account Through <span style="color:red;font-weight:bold;">Cimb</span></h3>
    <br><br>
     <h5> Below the instructions there is a button that will proceed you to CimbClicks</h5>
    <br>
     <h5><b>1. Login to your respective CimbClicks account, then click pay and transfer when you are logged-in</b></h5><br>
    ...
    <br>
    <img src="img/transfer.PNG" class="img-responsive" style="width:80%;margin-left:130px;border: 2px solid black;"/>
    <br><br>
    ...
    <div class="btn-gamp" onclick="myFunction()"><a href="https://www.cimbclicks.com.my/clicks/#/" style="color:white;background-color:red;margin-left:200px;"; target="_blank"><b>Cimb</b></a></div>
     <br><br>    <br><br>
     <script>
     function myFunction() {
     confirm("You will be directed to a new tab(CIMB), Please make sure you have read the instructions before proceeding. If you have not read the instructions you can refer this current tab");
      }
	  </script>
