...
<body>
  ...
  <section class="contact-page">
      ...
      <div class="container">   
           <div class="text-center" style="margin-right:275px;">
      <div class="btn-gamp"><a href="profilepassedit.php" style="background-color:#65AAF0;color:white;border:none;margin-left:10px;"><b>Edit Password</b></a></div>
       <div class="btn-gamp"><a href="profileuseredit.php" style="background-color:#65AAF0;color:white;border:none;margin-left:10px;"><b>Edit Username</b></a></div>
          <div class="btn-gamp"><a href="profileinfoedit.php" style="background-color:#65AAF0;color:white;border:none;" ><b>Edit Info</b></a></div>
      </div>
          <br><br><br>
      <div class="text-center" style="background-color:#e0e0e0;width:50%;margin-left:300px;border-radius: 15px;">
        <h2 >User Profile</h2>
          ...
          <br/><br/>
          <h4 ><b>Name  </b><br/><br/> <?php echo  $customer_name; ?></h4><br/>
          <h4 ><b>Address </b><br/><br/> <?php  echo $customer_address; ?></h4><br/>
          <h4 ><b>Phone </b><br/><br/> <?php  echo $customer_phone; ?></h4><br/>
          <h4 ><b>Email  </b><br/><br/> <?php  echo $customer_email; ?></h4><br/>
      </div>
   <br><br><br>
      <!--/.row-->
    </div>
