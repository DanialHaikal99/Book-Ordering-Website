        ...
        <div class="navbar-collapse collapse">
          <div class="menu">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation"><a href="indexuser.php" class="active">Home</a></li>
              ...
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">
                <form class="form-inline">
                  <div class="form-group">
                    <div class="btn btn-primary btn-lg"><a href="booksuser.php">Learn More</a></div>
                  </div>
                </form>
              </div>
            </div>
    ...
    <div class="container">
      <div class="text-center">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6" style="margin-left:115px;">
          <div class="btn-gamp" ><a href="contactuser.php">Learn More</a></div>
        </div>
