 ...
 <?php
  ...
  <div class="gallery">
    ...
    <div class="text-center">
      <h2 style="margin-left:900px;"><?php echo $row['book_title']; ?></h2>
    </div>
    <div class="container" style="border:2px dashed white;">
	  ...
	  <br/><br/><br/>
	 <div class="btn-gamp" onclick="myFunction()"><a href="loginform.php" style="background-color:#65AAF0;color:white;border:none;">Add To Cart</a></div>
      </div>
         <script>
     function myFunction() {
     confirm("You are not signed-in, sign in?");
      }
	  </script>
    </div>
